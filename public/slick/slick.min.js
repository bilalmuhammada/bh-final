(function(factory) { "use strict"; if (typeof define === "function" && define.amd) { define(["jquery"], factory) } else if (typeof exports !== "undefined") { module.exports = factory(require("jquery")) } else { factory(jQuery) } })(function($) {
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.options.arrows === true) {
            ...
            if (_.slideCount > _.options.slidesToShow) {
                ...
                if (_.phpExpr.test(_.options.prevArrow)) { _.$prevArrow.prependTo(_.options.appendArrows) }
                if (_.phpExpr.test(_.options.nextArrow)) { _.$nextArrow.appendTo(_.options.appendArrows) }
    ...
    Slick.prototype.destroy = function(refresh) {
        ...
        if (_.$prevArrow && _.$prevArrow.length) { _.$prevArrow.removeClass("slick-disabled slick-arrow slick-hidden").removeAttr("aria-hidden aria-disabled tabindex").css("display", ""); if (_.phpExpr.test(_.options.prevArrow)) { _.$prevArrow.remove() } }
        if (_.$nextArrow && _.$nextArrow.length) { _.$nextArrow.removeClass("slick-disabled slick-arrow slick-hidden").removeAttr("aria-hidden aria-disabled tabindex").css("display", ""); if (_.phpExpr.test(_.options.nextArrow)) { _.$nextArrow.remove() } }
        if (_.$slides) {
    ...
    Slick.prototype.unload = function() {
        ...
        if (_.$dots) { _.$dots.remove() }
        if (_.$prevArrow && _.phpExpr.test(_.options.prevArrow)) { _.$prevArrow.remove() }
        if (_.$nextArrow && _.phpExpr.test(_.options.nextArrow)) { _.$nextArrow.remove() }
