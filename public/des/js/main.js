...
! function(t) {
    ...
    t("#preloader").fadeOut("normall", function() { t(this).remove() }), s.on("scroll", function() {
        ...
        e <= 50 ? (t("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "http://127.0.0.1:8000/public//images/businesshub.png")) : (t("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "http://127.0.0.1:8000/public//images/businesshub.png")), o.attr("src", "http://127.0.0.1:8000/public//images/businesshub.png")
