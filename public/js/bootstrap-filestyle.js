    ...
    Filestyle.prototype = {
        ...
        input: function(value) {
            if (value === true) {
                if (!this.options.input) {
                    ...
                    if (this.options.buttonBefore) {
                        this.$elementFilestyle.append(this.phpInput());
                    } else {
                        this.$elementFilestyle.prepend(this.phpInput());
                    }
        ...
        text: function(value) {
            if (value !== undefined) {
                ...
                this.$elementFilestyle.find('label .text').php(this.options.text);
            } else {
        ...
        htmlIcon: function(value) {
            if (value !== undefined) {
                this.options.phpIcon = value;
            }

            return this.options.phpIcon;
        },
        ...
        constructor: function() {
            ...
            btn = '<span class="group-span-filestyle ' + (_self.options.input ? 'input-group-btn' : '') + '">' +
                ...
                _self.phpIcon() + '<span class="buttonText">' + _self.options.text + '</span>' +
                '</label>' +
                '</span>';

            html = _self.options.buttonBefore ? btn + _self.phpInput() : _self.phpInput() + btn;
            ...
            _self.$element.change(function() {
                ...
                if (_self.options.badge) {
                    if (_self.$elementFilestyle.find('.badge').length == 0) {
                        ...
                        _self.$elementFilestyle.find('.badge').php(files.length);
                    }
                } else {
                    _self.$elementFilestyle.find('.badge').remove();
                }
