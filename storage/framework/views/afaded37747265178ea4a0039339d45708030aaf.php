...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('slick/slick.css?v2022')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('slick/slick-theme.css?v2022')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('select2/css/select2.min.css')); ?>">
</head>
<style>
    .hero-image {
        background: url(<?php echo e(asset('images/hero-image-desktop.png')); ?>) no-repeat center;
    ...
    <!-- <div class="col-" style="padding:0px 0px 0px 20px;">
            <div class="logo">
                <a href="<?php echo e(env('BASE_URL')); ?>">
                    <img src="<?php echo e(asset('images/businesshub.png')); ?>" title="businesshub " alt="businesshub" width="185"/>
                </a>
                </div>
                </div> -->
        <div class="col-md-4">
                ...
                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option data-flag-url="<?php echo e($country->image_url); ?>" data-country-id="<?php echo e($country->id); ?>" value="<?php echo e($country->id); ?>">&nbsp; &nbsp; <?php echo e($country->nice_name); ?></option>
        ...
        <div class="col-md-4" style="padding:0px 0px 0px 0px;">
            <div class="logo text-center">
                <a href="<?php echo e(env('BASE_URL')); ?>">
                    <img src="<?php echo e(asset('images/businesshub-slogan.png')); ?>" title="businesshub " alt="businesshub" width="200"/>
                </a>
            </div>
        </div>
...
<!-- <div class="col-xl-4 col-md-4 col-lg-4 col-4">
            <div class="logo text-right" style="margin-top:30px;">
                <a href="<?php echo e(env('BASE_URL') . 'home'); ?>"><b>العربية</b></a>
            </div>
        </div> -->
</div>
</div>
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('images/slider-images/image2.jpg')); ?>" alt="Los Angeles" width="100%" height="auto">
                    <div class="hero-text">
                ...
                <!-- <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image1.jpg')); ?>" alt="Chicago" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image3.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <!-- <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image4.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image5.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <!-- <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image 6.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image 7.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image8.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/slider-images/image9.jpg')); ?>" alt="New York" width="100%" height="auto">
                    <div class="hero-text">
                        <p class="main">Welcome to the World's #1 <br/>online business website!</p>
                        <p class="text-center" style="font-size:20px;margin-top:30px;">Which country would you like
                            to explore?</p>
            ...
            <div class="col-lg-12" style="border:0px solid red;">
              ...
              <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-2" style="margin:10px 15px;">
                    <div class="row">
              <a class="mx-auto" href="<?php echo e(env('BASE_URL') . 'home?country=' . $country->id); ?>" style="border:0px solid red;">
                <div class="col-md-12 main-div" class="main-div" style="border:0px solid red;">
                        <span>
                            <img src="<?php echo e(asset('images/businesshub.png')); ?>" alt="businesshub" title="businesshub" width="60px">
                        </span>
                        <br/>
                        <span class="spans"><?php echo e($country->nice_name); ?></span>
                        <div>
                            <img src="<?php echo e($country->image_url); ?> " alt="<?php echo e($country->iso); ?>" title="<?php echo e($country->iso); ?>" class="flag2" width="40px">
                        </div>
                    </div>
                    </a>
                 </div>
...
<section class="mobile-view">
    <div class="container">
        ...
        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a class="mx-auto" href="<?php echo e(env('BASE_URL') . 'home'); ?>">
                <div class="col mx-auto main-div">
           <span>
            <img src="<?php echo e(asset('images/businesshub.png')); ?>" alt="businesshub" title="businesshub" width="70px">
            </span></br>
            <span class="spans"><?php echo e($country->nice_name); ?></span>
                    <div>
                    <img src="<?php echo e($country->image_url); ?> " alt="<?php echo e($country->iso); ?>" title="<?php echo e($country->iso); ?>" class="flag2" width="40px">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-6 mb-30 col-12 ">
                    <div class="subcategory-list">
                        ...
                        <br>
                        <?php $__currentLoopData = $category->sub_categories->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$sub_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a link="<?php echo e(env('BASE_URL') . 'ads/' . $sub_category->id); ?>" class="cf subcategory-name"><?php echo e($sub_category->name); ?></a>
                            <br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<script type="text/javascript ">
    var base_url = "<?php echo e(env('BASE_URL')); ?>";
...
<?php /**PATH C:\wamp64\www\bussinesshup\bh3\businesshub-web\resources\views/home/index.blade.php ENDPATH**/ ?>