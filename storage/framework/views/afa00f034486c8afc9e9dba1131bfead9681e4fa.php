                        ...
                        <div class="ragisterarea" style="border:0px solid red;margin-top:-30px;">
                            ...
                            <form>
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-xl-9">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/name.png')); ?>" width="33" height="19"/></span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/phone.png')); ?>" width="33" height="21"/></span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/envelop.png')); ?>" width="33" height="19"/></span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/city.png')); ?>" width="34" height="21"/></span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/massage.jpg')); ?>" width="33" height="21"/></span>
                                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><img src="<?php echo e(asset('images/envelop.png')); ?>" width="33" height="21"/></span>
                                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bussinesshup\bh3\businesshub-web\resources\views/contact-us.blade.php ENDPATH**/ ?>