        ...
        <div class="modal-content"
            ...
            <div class="modal-body text-center text-white py-4 position-relative">
                ...
                <div class="d-flex align-items-center justify-content-center mb-2"
                    style="position: relative; margin-bottom: 16px !important; margin-top: -10px;">
                    <h5 id="modal-title"
                        style="font-weight: bold; line-height: 20px; color: #A17A4E; font-size: 1.1rem; margin: 0 auto;"
                        class="login-heading">
                        Verify OTP
                    </h5>
                    <button type="button" class="close" data-dismiss="modal"
                        style="color: white; position: absolute; right: 10px; top: 44%; transform: translateY(-50%); font-size:24px; background:none; border:none; outline:none; padding: 0;">&times;</button>
                </div>
                ...
                <div class="alert-div" style="display: none; margin-bottom: 20px;">
                    <div class="alert alert-danger border-0 p-2" role="alert"
                        style="background: rgba(255,0,0,0.1); color: #ff5e5e; font-size: 13px; border-radius: 4px;">
                        <span class="alert-text"></span>
                        <button type="button" class="close text-white opacity-50"
                            onclick="$(this).closest('.alert-div').hide()"
                            style="font-size: 18px; line-height: 1; padding: 0.5rem 0.75rem;">&times;</button>
                    </div>
                </div>
                    ...
                    <form id="verifyOtpForm">
                        ...
                        <div id="forgot-password-fields" style="display:none;">
                            <div class="input-group mb-3"
                                ...
                                <input type="password" id="new_password" name="password" class="form-control login-user"
                                    placeholder="New Password"
                                    style="background: transparent; border: 1px solid #A17A4E; color: #fff; padding: 10px 11px; border-radius: 4px; width: 100%;">
                                <span class="toggle-password"
                                    onclick="toggleOtpPassword('new_password', this)">👁️</span>
                            </div>
                            <div class="input-group mb-3"
                                style="display: flex; align-items: stretch; position: relative;">
                                <input type="password" id="confirm_password" name="password_confirmation"
                                    ...
                                    style="background: transparent; border: 1px solid #A17A4E; color: #fff; padding: 10px 11px; border-radius: 4px; width: 100%;">
                                <span class="toggle-password"
                                    onclick="toggleOtpPassword('confirm_password', this)">👁️</span>
                            </div>
                        </div>
