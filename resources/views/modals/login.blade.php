                ...
                <div class="">
                    <div class="loginarea">
                        ...
                        <form class="login-form" id="login-form"
                            style="width:100%;margin-left: -4px;padding: 1rem; margin-top: 0px;">
                        ...
                        {{-- <div class="or">
                            <p style="text-align:center;color:#A17A4E;font-size:11px; margin-top: 12px; ">OR SIGN IN
                                WITH</p>
                        </div> --}}
                        ...
                        {{-- <div class="login-social-modal">
                            <span>
                                <img src="{{asset('images/instagram.png')}}" width="25" height="25" />
                            </span>
                            <span style="margin:0 10px;">
                                <img src="{{asset('images/fb.png')}}" width="25" height="25" />
                            </span>
                            <span>
                                <img src="{{ asset('images/socialicon/twitter.png')}}" alt="" width="30" height="30">
                            </span>
                            <span>
