  ...
  <div class="modal-dialog" style="width: 500px;margin-top:100px;">
    <div class="modal-content" style="padding: 5px;">
      ...
      <div class="modal-header">
        <div class="row">
            <div><img src="{{ asset('images/notifications-on.svg') }}" height="30" width="30"></div>
            <div>
      ...
      <div class="col-md-12" style="border: 1px solid rgb(224, 225, 227);box-shadow: rgba(0, 0, 0, 0.04) 0px 2px 8px;border-radius: 10px;">
            ...
            <div>
                ...
                <div class="col-md-2">
                <div class="row">
             <img src="{{ asset('images/image1.avif')}}" width="50" height="50">
            <img src="{{ asset('images/image1.avif')}}" width="50" height="50" style="margin: 0px -30px;z-index:1;">
            <img src="{{ asset('images/image1.avif')}}" width="50" height="50" style="margin: 0px -10px;">
             </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                    <div><img src="{{ asset('images/email-notifications.svg') }}" height="30" width="30"></div>
            <div>
                <h4 style="font-size: 16px;"><b>Enable notifications</b></h4>
                <p style="font-size: 12px;">Get notified when ads match your search</p>
            </div>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-10">
                    <div class="row">
                    <div><img src="{{ asset('images/push-notifications.svg') }}" height="30" width="30"></div>
            <div>
                <h4 style="font-size: 16px;"><b>Enable notifications</b></h4>
                <p style="font-size: 12px;">Get notified when ads match your search</p>
            </div>
