    ...
    <div class="col-md-6 mx-auto">
        ...
        <p style="margin-bottom: -15px; font-size:14px; color:blue;">
            <span class="menucolor"> <a href="javascript:history.back()" style="color: inherit; text-decoration: none;">
                    {{ $Categories->name }}
                </a> </span> > <span style="color:blue;">{{ $listing->subcategory_name }}</span>
        </p>
    </div>
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" name="manufactured_year"
                            placeholder="Manufactured Year" required>
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <div class="form-group form-focus">
                <input type="number" class="form-control floating" name="phone" placeholder="" title="" required>
