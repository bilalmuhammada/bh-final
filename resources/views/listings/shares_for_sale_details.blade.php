    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating number-format" onwheel="this.blur()" inputmode="numeric" name="share_price"
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" onwheel="this.blur()" name="share_amount"
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating number-format" onwheel="this.blur()" inputmode="numeric" name="lease_amount"
                            placeholder="" title="" required>
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" onwheel="this.blur()" name="whatsapp"
                            placeholder="" title="Please enter a valid 10-digit Mobile number" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-controlz form-control country" name="country" style=" font-size: 0.9rem;color:#000;"
