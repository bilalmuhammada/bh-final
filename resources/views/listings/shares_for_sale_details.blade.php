...
@section('content')
    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <div class="form-group form-focus">
                <input type="text" class="form-control floating"  name="share_amount" placeholder="" style="padding:22px;" required>
    ...
    <div class="col-md-6 mx-auto" style="margin-top: 20px;">
        ...
        <div class="col-md-6">
            <div class="form-group form-focus">
                <input type="text" class="form-control floating" name="share_percentage" placeholder="" style="padding:22px;"
                    title="" required>
...
<div class="col-md-6 mx-auto" style="margin-top: 20px;">
    ...
    <div class="col-md-6 mx-auto" style="margin-top: 20px;">
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <div class="form-group form-focus">
            <textarea name="products_and_services_offered" class="form-control floating" maxlength="100" placeholder=" style="height: 120px;"
                      required></textarea>
