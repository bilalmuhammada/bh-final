...
@section('content')
    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <input type='hidden' class='form-control longitude' id='longitude' name='longitude' placeholder='Enter Longitude'>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating number-format" onwheel="this.blur()" inputmode="numeric" name="price" placeholder=""
                            required>
                ...
                {{-- <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="manufactured_year"
                            oninput="validatePhoneNumber(this)" placeholder="Manufactured Year" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" onwheel="this.blur()" name="established_year"
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating number-format" onwheel="this.blur()" inputmode="numeric" name="least_amt"
                            placeholder="" {{-- pattern="\d{10}" --}} title="Please enter a valid 10-digit  number"
                            required>
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating number-format" onwheel="this.blur()" inputmode="numeric" name="invt_value"
                            placeholder="" {{-- pattern="\d{10}" --}} title="Please enter a valid 10-digit  number"
                            required>
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" onwheel="this.blur()" name="whatsapp"
                            placeholder="" {{-- pattern="\d{10}" --}} title="" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-controlz form-control floating country" name="country"
                        style=" font-size: 0.9rem;color:#000;" required>
                ...
                <div class="col-md-6">
                    <select class="form-controlz city form-control floating" name="city"
                        style=" font-size: 0.9rem;color:#000;" required>
