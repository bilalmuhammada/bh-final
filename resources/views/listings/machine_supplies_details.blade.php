    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="price_term" placeholder="" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" onwheel="this.blur()" name="stock_level"
                            placeholder="" required>
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="condition" placeholder="" required>
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="seller_financing " placeholder="" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-controlz  form-control country" name="country"
                ...
                <div class="col-md-6">
                    <select class="form-controlz form-control city" name="city" style=" font-size: 0.9rem;color:#000;"
                        required>
