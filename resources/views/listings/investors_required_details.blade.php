    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto">
            <div class="form-group form-focus">
                <input type="text" class="form-control floating" name="title" value="" placeholder="Title" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="business_modal" placeholder="" title=""
                            required>
                ...
                {{-- <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="reason_for_investment" placeholder=""
                            title="" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="number" class="form-control floating" name="established_year" onwheel="this.blur()"
                            placeholder="" required>
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-controlz country form-control floating" name="country"
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <div class="form-group form-focus">
                <input type="text" class="form-controlz location_name form-control floating" name="location_name"
                    placeholder="" required>
