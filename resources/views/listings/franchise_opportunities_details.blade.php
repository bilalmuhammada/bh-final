    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" onwheel="this.blur()" name="finance_term"
                            placeholder="" {{-- pattern="\d{10}" --}} title="Please enter a valid 10-digit  number"
                            required>
                        <label class="focus-label">Financing Term</label>
                    </div>
                    {{-- <div class="invalid-feedback">
                        Please provide a valid 10-digit Mobile number.
                    </div> --}}
        ...
        <div class="col-md-6 mx-auto">
            <div class="form-group form-focus">
                <textarea name="products_and_services_offered" class="form-control floating" maxlength="" placeholder=""
        ...
        <div class="col-md-6 mx-auto">
            <div class="row">
                ...
                <div class="col-md-6">
                    <select class="form-controlz  form-control floating city" name="city"
                        style=" font-size: 0.9rem;color:#000;" required>
