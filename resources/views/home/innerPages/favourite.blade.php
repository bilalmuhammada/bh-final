...
<!-------->
    ...
    <div class="col-md-12 mx-auto" style="border: 0px solid #E0E1E3;border-radius:6px;padding:15px 20px;margin-top:10px;">
        ...
        <div style="text-align: center;font-weight:bold;"><h4>You have no favorites yet in Business Ideas</h4></div>
        <div style="text-align: center;font-weight:bold;"><h6>Use the favorite icon to save ads that you want to check later</h6></div>
        <div style="text-align: center;font-size:12px;" class="text-muted"><p>Access your favorites anytime by clicking on the favorites button in the top nav bar</p></div>
        </div>
