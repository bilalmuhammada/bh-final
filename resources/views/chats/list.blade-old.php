                        ...
                        <div class="chat-cont-left">
                            <div class="row"  style="padding:5px 8px;">
                              ...
                              <div class="col-md-4"></div>
                                <div class="col-md-2">
                                <div class="row">
                                    <div class="col-md-12 text-center"><button class="btn btn-danger" id="deleteSelected"><i class="fa fa-trash"></i></button></div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="chat-users-list" id="chat-users-list">
                                <div class="chat-scroll">
                                    ...
                                    @foreach($chats as $chat)
                                        <input type="checkbox" style="position:relative;top:57px;right:210px;"
                                    ...
                                    @if($chat->status == 'accepted')
                                        ...
                                        <div class="chat-footer">
                                            <div class="input-group">
                                                ...
                                                <div class="inputs" style="padding:4px;width:88%;height:42px !important;">
                                                ...
                                                <button type="button" class="btn btn-primary msg-send-btn"
                                                        data-user-id="{{ getSafeValueFromObject($chat->other_user, 'id') }}"
                                                        data-chat-id="{{ $chat->id }}" style="background-color:inherit !important;"><i
                                                        class="fa fa-paper-plane" aria-hidden="true" style="color:#0504aa;font-size:30px;background-color:none !important;"></i></button>
                                            </div>
                                        </div>
                                    @else
                                        <div class="chat-body">
