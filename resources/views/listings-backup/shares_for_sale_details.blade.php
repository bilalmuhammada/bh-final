...
@section('content')
    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <input type="text" class="form-controlz" name="share_amount" placeholder="Share Amount" style="padding:22px;" required>
            <div class="invalid-feedback">
    ...
    <div class="col-md-6 mx-auto" style="margin-top: 20px;">
        ...
        <div class="col-md-6">
                <input type="text" class="form-controlz" name="share_percentage" placeholder="Share Percentage" style="padding:22px;"
                    title="" required>
            <div class="invalid-feedback">
...
<div class="col-md-6 mx-auto" style="margin-top: 20px;">
    ...
    <div class="col-md-6 mx-auto" style="margin-top: 20px;">
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <textarea name="products_and_services_offered" class="form-controlz" maxlength="100" placeholder="Products & Services Offered" style="height: 120px;"
                      required></textarea>
            <div class="invalid-feedback">
