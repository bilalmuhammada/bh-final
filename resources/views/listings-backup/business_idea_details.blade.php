...
@section('content')
    ...
    <div class="col-md-6 mx-auto" style="margin-top: 20px;">
        ...
        <div class="col-md-6">
        <select class="form-controlz" name="estimated_sales_in_numbers" required>
                {{-- <option selected disabled>Estimated Sales</option> --}}
                <option selected disabled>Make self Type Bar</option>
