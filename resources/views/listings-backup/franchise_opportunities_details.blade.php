    ...
    <form class="place-ad-form" enctype="multipart/form-data">
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-controlz" name="franchise_fee" placeholder="Franchise Fee" style="padding:22px;"
                           required>
                    <div class="invalid-feedback">
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <div class="row">
                <div class="col-md-6">
                    <input type="text" class="form-controlz" name="established_year" placeholder="Established Year" style="padding:22px;"
                           required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-controlz" name="no_of_branches" placeholder="No of Branches" style="padding:22px;"
                           title="" required>
                    <div class="invalid-feedback">
        ...
        <div class="col-md-6 mx-auto" style="margin-top: 20px;">
            <textarea name="products_and_services_offered" class="form-controlz" maxlength="1000" placeholder="Products & Services Offered"
                      style="height: 120px;"
                      required></textarea>
            <div class="invalid-feedback">
