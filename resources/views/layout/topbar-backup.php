...
<header>
    ...
    <div class="topbar desktop-view">
        <div class="container-fluid" style="border:2px solid red;padding:0px 20px;">
            <div class="row">
                <div class="col-lg-2 col-xl-2 col-md-2" style="border:2px solid red;">
                    <!-- social icon desktop start -->
                    <a class="navbar-brand pt-2" href="{{env('BASE_URL') . 'home?country=' . request()->country . '&city=' . request()->city}}">
                        <img src="{{asset('images/businesshub.png')}}" alt="businesshub" title="businesshub">
                    </a>
                </div>
                <div class="col-lg-3 col-xl-3 col-md-3" style="border:2px solid red;">
                    <!-- <div class="col-md-4"> -->
                    <span style="position:relative;top:20px;border:0px solid red;">
                    <!-- country bar mobile start -->
                        <div class="mobile-country desktop-menu-right">
                            <div class="row">>
                            <div class="country" style="border:1px solid red;">
                                <select class="form-control city_dropdown" name="city_dropdown" id="" style="width:60px;border:2px solid red !imporatnt;">
                            ...
                            <!----langs--->
                            <div class="country" style="border:3px solid green;">
                            <div class="mobile-country desktop-menu-right">
                ...
                <!-----icons---bar---->
                <div class="col-md-4 col-xl-4 col-md-5">
                    <div class="social-icon float-left text-dark">
                        <div class="row align-middle" style="font-size: 11px;color:black;border:2px solid red;">
                <span style="padding:5px 10px;text-align:center;">
                                <a type="button" id="notifications"
                                   data-toggle="dropdown"
                                   aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('images/my-notifications.svg')}}" width="15" height="15">
                                    <div>
                            ...
                            <span style="padding:5px 10px;text-align:center;">
                                <a type="button" id="searches" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('images/my-searches-selected.svg')}}" width="15" height="15">
                                    <div>
                            ...
                            <span style="padding:5px 10px;text-align:center;">
                                <a type="button" id="favorite" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('images/my-favorites.svg')}}" width="15" height="15">
                                    ...
                                    @if (session()->has('user') && count($favourite_ads) > 0)
                                        ...
                                        @foreach($favourite_ads as $favourite_ad)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-sm-7 col-7">
                                                    <a class="link" href="{{ env('BASE_URL') . 'ads/detail/' . $favourite_ad->id . '?country=' . request()->country . '&city=' . request()->city}}">
                            ...
                            <span style="padding:5px 10px;text-align:center;">
                                <a type="button" id="chat"
                                   ...
                                   aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('images/my-chats.svg')}}" width="15" height="15">
                                    <div><span style="color: #000;">Chat</span></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="chat" style="padding: 10px;width:350px;">
                                    @if (session()->has('user') && count($chats) > 0)
                                        <!---------inner area------------>
                                            ...
                                            <div class="col-lg-8 col-sm-7 col-7">
                                                <p style="font-size: 13px;">Lorem ipsum dolor sit amet, consectetur<br/><span
                                                        style="font-size: 11px;font-size:bold;">By Alex</span>
                                                </p>
                                            </div>
                            ...
                            <span style="padding:5px 15px;text-align:center;">
                                <a type="button" id="ads"
                                   ...
                                   aria-haspopup="true"
                                   aria-expanded="false">
                                    <i class="fa fa-user" width="15" style="color: #999;"></i>
                                    <div><span style="color: #000;">My Ads</span></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="ads" style="padding: 10px;width:350px;">
                                    @if (session()->has('user') && count($my_ads_for_topbar) > 0)
                                        ...
                                        @foreach($my_ads_for_topbar as $my_ad)
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-sm-7 col-7">
                                                    <a class="link" href="{{ env('BASE_URL') . 'ads/detail/' . $my_ad->id . '?country=' . request()->country . '&city=' . request()->city}}">
                ...
                <!-----icons---bar---->
                <div class="col-lg-3 col-xl-3 col-md-4" style="border:2px solid red;">
                    <div class="row pt-4" style="border: 0px solid red;color:#000;">
                        <div class="col-md-12">
                            @if (session()->has('user'))
                                <a class="link" href="{{ env('BASE_URL') . 'user/profile?country=' . request()->country . '&city=' . request()->city}}">
                                ...
                                <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item link" href="{{ env('BASE_URL') . 'user/profile?country=' . request()->country . '&city=' . request()->city}}">My Profile</a>
                                            <a class="dropdown-item link" href="{{ env('BASE_URL') . 'user/ads?country=' . request()->country . '&city=' . request()->city}}">My Ads</a>
{{--                                            <a class="dropdown-item" href="{{ env('BASE_URL') . 'user/searches'}}">My Searches</a>--}}
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <!-- navigation toggle start -->
            <a class="navbar-brand mobile-view link" href="{{ env('BASE_URL') . 'home?country=' . request()->country . '&city=' . request()->city}}">
