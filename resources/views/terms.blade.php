...
<p style="text-align: justify;">
    ...
    <ul style="list-style-type: disc; padding-left: 40px;">
        ...
        <li>be based on the reviewer's actual experience and not on personal bias or irrelevant factors; and</li>
...
<ul style="padding-left: 40px;">
    <li>If you are using the Platform in a business or commercial capacity: We provide the Platform and the Content to you ‘as is’ and ‘as available’. We exclude all implied conditions, warranties, representations or other terms that may apply to the Platform or any Content. We will not be liable to you for any loss or damage, whether in contract, tort (including negligence), breach of statutory duty or otherwise, even if foreseeable, arising under or in connection with your use of, or inability to use, the Platform, or your use of or reliance on any Content. In particular, we will not be liable to you for any:
        <ul style="padding-left: 40px;">
            <li>(i) loss of profits, sales, business or revenue;</li>
            <li>(ii) business interruption;</li>
            <li>(iii) loss of anticipated savings;</li>
            <li>(iv) loss of business opportunity, goodwill or reputation;</li>
            <li>(v) loss or corruption of data; or</li>
            <li>(vi) indirect or consequential loss or damage.</li>
        </ul>
    </li>
...
<p style="text-align: justify;">
    <strong>Contact:</strong> You may contact us by emailing <a href="mailto:support@businesshub.at">support@businesshub.at</a>. If we need to contact you, we will write to the email address associated with your Account (if any).
</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
    <strong>Nobody else has any rights under these Terms of Use:</strong> These Terms of Use are between you and BusinessHub only, and no other person will have any rights to enforce or rely on any of its provisions.
</p>
<p style="text-align: justify;">
...
<h4 style="text-align: center;">ADDITIONAL TERMS – VERIFIED BUSINESS ACCOUNT</h4>
<p style="text-align: justify;">
    These Additional Terms for Verified Business Account (these "Business Account Terms") govern the use of our ‘Verified Business Account’ feature available through <a href="http://www.businesshub.at">www.businesshub.at</a> and through any BusinessHub mobile application available from time to time (collectively, the "Platform"). 
</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
    Your subscription will start on the day we confirm to you that our verification process has been completed.
</p>
<p style="text-align: justify;">
    The Feature is subject to a monthly subscription (the price of which will be displayed at checkout). The price of the subscription may change from time to time at BusinessHub’s discretion (if that happens, BusinessHub will inform you via email before the new subscription price comes into effect).
</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
    If you choose to cancel your subscription, you will have access to the Feature until the end of the then-current Billing Cycle.
</p>
...
<p style="text-align: justify;">
    It is your responsibility to ensure that the payment method you select at checkout has sufficient funds to cover the Subscription Fees in each Billing Cycle. BusinessHub will not have any responsibility in the event you incur additional fees or charges as a result of your choice of payment method.
</p>
<p style="text-align: justify;">
