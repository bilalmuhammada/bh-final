            ...
            <div class="row mb-20px">
                <div class="col-md-12 col-lg-12 col-xl-12 term-text">
                   ...
                   Please read this Policy carefully, as it contains important information on who we are and how we collect, store, use and share your information. By accessing the Platform or using our Platform Services or otherwise indicating your consent, you agree to, and where required, consent to the collection, use and transfer of your information as set out in this policy. If you do not accept the terms of this policy, you must not use the Platform and/or the Services. This Policy supplements other notices and policies and is not intended to override them.
                     ...
                     <span>This Policy:
                    <ul>
                        <li>Applies only to the Platform and not to websites or applications of other companies or organisations;</li>
                        <li>Specifically addresses our obligations pursuant to local law.</li>
                    </ul>
                     </span>
                     <span>
                    ...
                    <span>We will use this information for several reasons including:
                        <ul>
                            ...
                            <li>To provide Clients with updates or additional Businesses and Services advertised on our Platforms.</li>
                            <li>To enable interested Clients to see detailed descriptions and images or videos of Business and Services that may be of interest to them;</li>
                            <li>To allow users to check prices and offers for Businesses and Services via our Platform;</li>
                            <li>Using the information collected for commercial purposes, such as analysing market trends, creating databases and automated services, and promoting our Platforms and Services on social media and other third-party platforms;</li>
                        </ul>
...
<span>We have a legitimate interest to process this Personal Information. These legitimate interests are:
    <ul>
        <li>Providing a service to Clients by helping them to market Goods and Services and understand changing market dynamics and evolving trends;</li>
        <li>Providing our Platform Services to Clients by advertising Goods and Services to potential buyers or sellers; and</li>
        <li>Providing our Platform Service to potential buyers or sellers so that they know what Goods and Services are currently on the market, the price of those Goods and Services using the information inserted by Clients on our Platforms via adverts;</li>
    </ul>
</span>
...
<span><b>Contacting  Clients for Inquiries:</b></span><br/>
<span>
...
<ul>
    ...
    <li>If you choose to contact any Clients using the telephone number on our Platforms, calls may be recorded for training, monitoring and quality assurance purposes. We may also process call recordings for the purpose of fulfilling our contract or Platform Services with Clients. We may also keep a record of call activity, including missed calls.</li>
</ul>
</span>
...
<ul>
    ...
    <li>send enquiries to Clients or contact us copies will be available to view in your BusinessHub account:</li>
    <li>request email updates such as Business and Services alerts about when any Goods and Services are marketed for your interest based off your search parameters;</li>
    <li>where we have made the following features available to you, these will be available to view in your Business account:</li>
...
<ul>
    ...
    <li>downloading the App or registering either by creating an account with us or using another third party platform such as facebook, google or apple to use  App;</li>
    ...
    <li>entering into competitions, promotions, surveys and market research studies made available on our Platforms or if we contact you by email, phone, text, whatsapp or otherwise; and</li>
    <li>engaging with additional Platform Services that are available on our Platform, such as the Dubizzle Verified function which requires government-issued ID and a five second video selfie:</li>
</ul>

<span><b>Communications:</b></span>
<ul>
   <li>Personal Information that you provide by corresponding with us by phone, e-mail, SMS, whatsapp or otherwise;</li>
   <li>If you choose to contact us by phone or email or whatsapp or we call you, calls may be recorded for training, monitoring and quality assurance purposes and for the purpose of fulfilling our Platform Services with Clients. Phone calls may be monitored in real time. We may also keep a record of call activity, including missed calls.</li>
</ul>
<span><b>Pre-Approval:</b></span>
<ul>
<li>If you choose to apply for a finance pre-approval or use our finance calculator,  you may be asked to provide Personal Information about yourself. For example, name, email, mobile number, bank details and government-issued ID. Business is not a financial institution and only provides intermediaries services via our Platform Services.  
</li>
</ul>
<h6 class="terms">Why we collect it</h6>
<span>We will use this Personal Information:</span><br>
<span>Enquiries to Clients:</span><br>
<span><b>To make sure that you receive the intended Platform Service. This may include:</b></span><br>
<ul>
    <li>transferring your Business and Services inquiry to the Client who is advertising the Business or Services so that they can respond to your inquiry directly. Please note that some Clients may be contacted in the following way by;
</li>
    <li>lead handling to process your enquiry on Clients behalf by interaction with the advertisement via pressing the call, email, chat or sms links; or
</li>
    <li>third party systems to process and store your enquiry to allow them to respond to and manage your enquiry by interaction with the advertisement via pressing the call, email, chat or sms links;
</li>
    <li>sending your name, address and contact details to the Clients when you request information on a Business or Services they are advertising so that they can contact you;
</li>
    <li>enabling us to send you a link to access an online viewing of the Business and Services you have enquired about via email, SMS or whatsapp;
</li>
    <li>Clients must form their own legal basis for processing your enquiry data if they are processing it for purposes other than responding to your initial enquiry. BusinessHub is not responsible for external third parties or Clients actions;
</li>
    <li>Where telephone calls are recorded, this is for training, monitoring and quality assurance purposes and for the purpose of fulfilling our Platform Services with Clients; and
</li>
...
<ul>
    ...
    <li>To provide alerts to you (which you have set up) for Goods and Services advertised on our Platforms that meet your search criteria;
</li>
    ...
    <li>To provide you customised content on our Platforms including suggesting Good and Services or Platform Services.
</li>
</ul>
<span><b>Use of the Platforms:</b></span>
<ul>
    ...
    <li>To contact you for your views on our Platform Services important changes concerning our Platforms or Platform Services;
</li>
    <li>To deliver relevant advertising to you whilst you are on our Platforms;
</li>
    <li>To deliver targeted advertising to you; and
</li>
    <li>To provide you customised content on our Platforms including suggesting Goods and Services or other Platform Services relevant to you.
</li>
</ul>
<span><b>Communications:</b></span>
<ul>
    <li> To process and resolve any queries that you may have raised;</li>
    <li>For training, monitoring and quality assurance purposes and for the purpose of fulfilling Client requests where calls (which may include video calls) are recorded.
</li>
...
<h6 class="terms">Our lawful basis for processing this Personal Information</h6>
<span>We have a legitimate business interest to process this Personal Information. These legitimate interests are:</span><br>
...
<ul>
    ...
    <li>To allow us to gain information about the use of our Platforms and any improvements that can be made;</li>
    ...
    <li>To ensure our Platform protects the interest and safety of our users. Data maybe retained for longer if fraud or a malicious activity is suspected.</li>
</ul>
<span><b>Communications: </b> To ensure that your queries are addressed and for training, monitoring and quality assurance purposes where calls are recorded;</span><br>
 <span><b>Pre-approval:</b>If you choose to apply for a finance pre-approval or use our finance calculator, you may be asked to provide Personal Information about yourself. For example, name, email, mobile number, bank details and government-issued ID. BusinessHub is not a financial institution and only provides intermediaries services via our Platform Services.</span><br>
...
<ul>
    <li>We will keep records of your Goods or Services inquiry from the date you made it, and we will hold onto the inquiry data until it is no longer necessary. Once you stop using our Platforms or Platform Services, the data will be deleted or made anonymous so that it no longer identifies you (unless required to keep it for other legal or regulatory obligations);
</li>
    <li>Telephone call recordings are stored until it is no longer necessary from the date of the recording, at which point they are deleted (unless required to keep it for other legal or regulatory obligations); and
</li>
    <li>Profiling data will be kept for as long as it is necessary.
</li>
</ul>
<span><b>Registered users and Alerts:</b> When you sign up as a user on BusinessHub, any Personal Information you provide will be stored as long as you have an active account. If you decide to delete your account, the Personal Information associated with it will also be deleted or anonymised (unless required to keep it for other legal or regulatory obligations).
</span><br>
<span><b>Use of the Platforms:</b></span>
<ul>
    <li>Any Personal Information you provide when downloading or registering for the App, or for accessing in-App services, will be stored for as long as you have the App installed on your device;
</li>
    <li>When you participate in competitions, promotions, surveys, or market research studies and provide Personal Information, we will only keep it for as long as we need it.
</li>
    <li>When you interact with us through social media platforms, any Personal Information you provide will only be kept on those platforms. We will not copy or store it separately. This information will be kept for as long as your social media account's privacy policy states.
</li>
</ul>
<span><b>Careers:</b></span>
<ul>
    <li>We retain Personal Information for as long as is required to fulfil the purpose (whether that be for the current job application or retaining on file for future job vacancies) or until you notify us that you wish for your Personal Information to be deleted.
</li>
</ul>
...
<ul>
    <li>This pertains to the technical information we collect, which is distinct from the Personal Information you provide to Us. We may collect:
</li>
    <li>Technical information that could potentially identify you, such as the type of device you use, its unique identifier (such as the IMEI number), the internet protocol (IP) address used to connect your computer to the internet, the MAC address of your device's wireless network interface, your mobile phone number, your login information, mobile network details, your device's operating system, the type and version of browser used on your device, its time zone setting, and details about browser plug-ins, operating system, and Platform, as well as login data;
</li>
    <li>Information about your interactions with our direct marketing and other communications, as well as your visit to our Platforms. We use tracking pixels to identify device types, open rates, and click-through information. We also collect the full Uniform Resource Locators (URL) clickstream to, though, and from our Platforms, including the date and time of your visit, the products viewed or searched for, page response times, download errors, length of visits to certain pages, page interaction information (such as scrolling, clicks, and mouse-overs), and methods used to browse away from the page. This helps us understand how you use our Platforms, products, or Platform Services;
</li>
    <li>Collect details of your use of our App or your visits via the App, the resources that you access and the advertisers and partners that you contact;
</li>
    <li>Use GPS technology on your Device to determine your location. Some of our location-enabled services require your Personal Information for the feature to work;
</li>
    <li>Set a unique application number which is contained within the App. When you install or uninstall the App or when the App searches for automatic updates, that number and information about your installation (for example, and the type of operating system) may be sent to us; and
</li>
<li>Combine technical information with other information that We have about you to help us with our processing of your Personal Information as set out in this Policy.
</li>
...
<ul>
    ...
    <li>To deliver relevant content and advertisements to you on our Platforms and measure or understand the effectiveness of the advertising we serve to you;</li>
    <li>To respond to and deal with your queries or complaints and to provide or improve our customer service to you;</li>
    <li>To provide you with GPS enabled functionality;</li>
    <li>To use data analytics to improve our Platforms, Platform Services, marketing, customer relationships and experiences;</li>
    <li>To conduct reviews that assist us in the improvement and optimisation of our Platforms;</li>
    <li>To identify what versions of the App are being used or when the App is uninstalled from a device;</li>
    <li>To ensure that content from our Platforms is presented in the most effective manner for you and for your device;</li>
    <li>As part of our efforts to keep our Platforms safe and secure;</li>
    <li>To administer our Platforms and for internal operations, including troubleshooting, data analysis, testing, research, statistical and survey purposes;</li>
...
<ul>
    ...
    <li>To provide customer support including dealing with your complaints, enquiries and to improve customer service;</li>
    <li>To help ensure the on-going security of the Platforms;</li>
    <li>To monitor quality and conduct staff training;</li>
    <li>To analyse how our Platforms are used, including customer behaviour, to improve and expand our Platform Services. This helps us develop our business and marketing strategies, define customer types, and keep our Platforms up-to-date and relevant; and
</li>
    <li>To operate our business and Platforms (troubleshooting, data analysis, testing, system maintenance, support, reporting and hosting of data, provision of administration and IT services, network security and to prevent fraud);
</li>
<li>When you sign up for the App and want to use the location data service that uses your Device's GPS tracker, we will use your voluntary action as consent to process your Personal Information for this purpose. You can at any time change the location services settings for the App on your device.
</li>
...
<p><span>We place great emphasis on safeguarding your information and have implemented effective technical and organisational measures to prevent unauthorised access or disclosure. However, it is essential to acknowledge that no security measure is entirely infallible. As a result, any transmission of your information is done at your own risk.
</span></p>

<p><span>We store your Personal Information in a central database that may be accessed by our affiliates. Please remember to keep your password and details confidential to ensure your privacy.
</span></p>
<p><span>When clicking on a link to visit the websites of advertisers or affiliates, please note that they have their own privacy policies. We are not responsible for their policies or the security of your personal information. We suggest reviewing their policies before sharing any Personal Information with them.
</span></p>
<h6 class="terms">Your Personal Information rights</h6>
<p>You may have certain rights in relation to your personal data as determined by applicable data protection law.</p>
<p>To exercise certain rights, you can contact us or review and select/deselect options on the Platform (if available). </p>
<p>If you ever want to stop receiving communications that we have sent you based on your preferences, you can unsubscribe or opt-out by contacting us directly or by clicking on the unsubscribe link, where available.
</p>
<p>If we process your Personal Information under legitimate interests and you object to it, any processing that has already occurred will not be affected. However, in some cases, objecting to the processing of all your Personal Information may limit your ability to use certain services or platforms we offer.
</p>
<h6 class="terms">BusinessHub Verification</h6>
<p>We provide BusinessHub Verification to establish your reliability, trustworthiness and safety for other Clients on our Platform creating a safer environment for genuine buyers and sellers of Business and Services. All you need is to submit a copy of your government-issued ID and a quick (five-second) selfie video. We keep this information secure to prevent any fraudulent or malicious actions such as identity theft, phishing scams, non-delivery and payment scams.
</p>
<p>It's important to note that while BusinessHub verification can enhance security, it’s still essential to exercise caution and follow best practices when engaging in online transactions. Clients should remain vigilant, protect their Personal Information and report any suspicious activity to the Platform administrators.
</p>
<h6 class="terms">Enquiries</h6>
<p>If you have any enquiry or concern about our Policy or the way in which we are handling personal data, please contact us at info@businesshub.com. If at any time you wish us to cease processing your information, please send a message to our admin department and insert "unsubscribe" as the subject heading.</p>
...
<p>We reserve the right to modify this Policy at any time. Any future changes will be available on our Platforms.</p>
<p>You may be required to read and accept any revised Policy to continue your use of our Platforms. The amended terms will be made available with new uploads or updates of the App and will be displayed in the Privacy Policy section of the App.</p>
<p>Please check back frequently to see any updates or changes to this Policy, as you will be deemed to accept such changes from your continued use of our Platforms.</p>
<p>To the extent that there is a conflict in the wording of this policy and any other translation of this policy or a policy in any other language, this policy shall take precedent.</p>
