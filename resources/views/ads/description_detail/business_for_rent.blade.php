<div class="col-lg-12 col-md-12 col-12" style="border-top: 1px solid #eee;border-bottom: 1px solid #eee;margin-top: 35px;margin-bottom: 10px;">
    <div class="row" style="margin-top:13px;">
        ...
        <div class="col-lg-6 col-md-6 col-6" >
            <p style="font-size: 14px;"><b>Business Status :</b>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Leaser Financing:</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Posted by
                :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Website
                :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Mobile
                :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
