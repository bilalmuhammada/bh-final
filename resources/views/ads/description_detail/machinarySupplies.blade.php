    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 col-7" >
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Price Term:</b>
                <span >{{ $formatted_number($ad->details->price_term ?? null) }}</span></p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 col-7">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Stock Level:</b>
                <span >{{ $formatted_number($ad->details->stock_level ?? null) }}</span></p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-5">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Stock Unit:</b>
                <span >{{ $formatted_number($ad->details->stock_unit ?? null) }}</span></p>
        </div>
        <div class="col-lg-7 col-md-7 col-7">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Condition:</b>
                <span >{!! $ad->details->condition ?? 'No' !!}</span></p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-5">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Seller Financing:</b>
                <span >{!! $ad->details->seller_financing ?? 'No' !!}</span></p>
        </div>
        <div class="col-lg-7 col-md-7 col-7">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Export:</b>
                <span >{!! $ad->details->export ?? 'No' !!}</span></p>
        </div>
    </div>
