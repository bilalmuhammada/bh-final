...
<div class="col-lg-12 col-md-12 col-12" style="margin-top: 6px; margin-bottom: 9px;">
    <div class="row" style="margin-top:13px;">
        ...
        <div class="col-lg-6 col-md-6 col-6" >
            <p style="font-size: 14px;"><b>Price Term :</b>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Stock Level :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Stock Unit :</b>
                <span>{{ $ad->details->reason_for_sale ?? '....' }}</span></p>
        </div>
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Condition :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Seller Financing :</b>
                <span>{{ $ad->details->reason_for_sale ?? '....' }}</span></p>
        </div>
        <div class="col-lg-6 col-md-6 col-6">
            <p style="font-size: 14px;"><b>Export :</b>
                <span>{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
    </div>
