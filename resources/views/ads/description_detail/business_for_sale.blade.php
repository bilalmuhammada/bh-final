    ...
    <div class="row">
        <div class="col-lg-5 col-md-5 col-5">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Trade Licence :</b>
                <span style="margin-left: 2px;">{{ $ad->details->lease_term ?? '....' }}</span></p>
        </div>
        <div class="col-lg-7 col-md-7 col-7">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Established Year :</b>
                <span style="margin-left: 15px;">{{ $ad->details->established_year ?? '....' }}</span></p>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 col-7">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Reason for Sale :</b>
                <span style="margin-left: 15px;">{{ $ad->details->reason_for_sale ?? '....' }}</span></p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-5">
            <p style="font-size: 14px; margin-bottom: 5px;"><b>Website :</b>
                <span style="margin-left: 2px;">{{ !empty($ad->details->open_for_partnership) && $ad->details->open_for_partnership == 1 ? 'Yes' : 'NO' }}</span>
            </p>
        </div>
        <div class="col-lg-7 col-md-7 col-7">
