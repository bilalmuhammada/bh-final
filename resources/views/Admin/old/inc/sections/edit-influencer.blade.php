                ...
                <div class="modal-dialog modal-dialog-centered" style="width: 600px;">
                  <div class="modal-content" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" value="Alex">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" Value="+77868687">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">Email</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" Value="xyz@gmail.com">
                    </div>
                   
                    <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">Country</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" Value="Dubai">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">City</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" Value="Arjman">
                    </div>
                    <div class="mb-3">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" Value="Arjmani">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Influencer Type</label>
                        <select class="js-example-basic-single form-select" data-width="100%">
										<option value="TX">Select Type</option>
										<option value="TX" selected>Buyer</option>
                    ...
                    <div class="mb-3">
                        ...
                        This textarea has a limit of 100 chars.
                        </textarea>
                    </div> -->
                    <!-- <div class="mb-3">
