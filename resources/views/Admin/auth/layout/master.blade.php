...
<body>
    ...
    <!-- Plugin js for this page -->
    <script src="{{ asset('admin_asset/assets/vendors/datatables.net/jquery.dataTables.js')}}"></script>
    <script src="{{ asset('admin_asset/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.js')}}"></script>
    <!-- End plugin js for this page -->
    ...
    <!-- Plugin js for this page -->
    <script src="{{ asset('admin_asset/assets/vendors/sweetalert2/sweetalert2.min.js')}}"></script>
    <!-- End plugin js for this page -->

    <!-- Custom js for this page -->
    <script src="{{ asset('admin_asset/assets/js/sweet-alert.js')}}"></script>
    <!-- End custom js for this page -->
