...
<style>
    ...
    #profile-form #select2-country-container,
    #profile-form #select2-cities-container {
    ...
    <div class="cont-w" style="margin-bottom:30px;">
        <div class="col-md-12" style="margin-left:42px;">
            <span class="changecolor">
                <a href="{{ url('home') . '?country=' . request()->country }}">Home</a> <span style="color:#0000FF"> >
                    Profile</span>
            </span>
        ...
        <div class="col-md-12 desktop-view">
            <div class="row">
                <div class="col-md-2" style="border: 0px solid red;text-align:center;">
                    <img id="profile-image" class="display-profile-img" src="{{session()->get('user')->image_url}}"
                        alt="img" width="120" height="120" style="border-radius: 0.3rem; border: 0px solid red;">
                        ...
                        <form class="profile-form" id="profile-form" style="font-size:13px;">
                            <div class="col-md-12" style="margin-top: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control form-control1" name="first_name" id="name"
                            ...
                            <div class="col-md-12" style="margin-top: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control1" name="last_name" id="name"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="gender" id="gender" type="text" class="form-control form-control1"
                                            ...
                                            <option value="male" @if(session()->get('user')->gender == 'male') selected
                                            @endif>Male</option>
                                            <option value="female" @if(session()->get('user')->gender == 'female') selected
                                            @endif>Female</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input name="mobile" id="mobile" type="text"
                                            value="{{ session()->get('user')->phone}}" class="form-control form-control1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="dob" id="datepicker1"
                                            value="{{ \Carbon\Carbon::parse(session()->get('user')->dob)->format('d.m.Y') }}"
                                            class="form-control datepicker1 form-control1 login-user email"
                                            onfocus="this.value=''">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group mb-3 countryfield">
                                            <select name="country" id="country_id"
                                                ...
                                                style="width:100%;">
                                                {{-- @if ($cities->count() < 1) <option value="" selected>Country</option>
                                                    @endif --}}
                                                    @foreach($countries as $country)
                                                        <option {{ $country->id == request()->country ? 'selected' : '' }}
                                                            value="{{ $country->id }}" style="font-size:13px !important;">
                                                            {{ $country->name }}
                                                        </option>
                                                    @endforeach
                                            </select>
                                        ...
                                        <div class="input-group mb-3 countryfield">
                                            <select name="cities" id="profile_cities"
                                                ...
                                                @foreach($cities as $city)
                                                    <option {{ $city->id == request()->city ? 'selected' : '' }}
                                                        value="{{ $city->id }}" style="font-size:13px !important;">
                                                        {{ $city->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    {{-- <div class="col-md-12">
                                        ...
                                        <span href="#" class="add-address">
                                            <button
                                                style="padding:5px 50px;border:none;border:1px solid #A17A4E; border-radius:4px;background:inherit;">+
                                                &nbsp; &nbsp; New Location</button>
                                        </span>
                                    </div> --}}
                                    <!-- <div class="col-md-8">
                ...
                <div class="col-md-5"
                    style="box-shadow: #eef0f1 0 0 20px; margin-left: 53px; border: 1px solid #eef0f1;height:130px;padding:10px;  border-radius:0.3rem;">
                    <div class="row">
                        <div class="col-md-3" style="border: 0px solid red;">
                            <div class="inner-content text-center" style="padding: 10px;">
                                <h6><b>Ads</b></h6>
                                <h6><b
                                        style="color: blue">{{ \App\Helpers\RecordHelper::getAdsByUserId(session()->get('user')->id)->count() }}</b>
                                </h6>
                        ...
                        <div class="col-md-3" style="border-left: 2px solid #eee;border-right: 2px solid #eee;">
                            <div class="inner-content text-center" style="padding: 10px 0px 0px 0px;">
        ...
        {{-- <div class="col-sm-12 mobile-view" style="margin-left: 20px;">--}}
            {{-- <div class="row">--}}
                {{-- <div class="col-xs-2" style="border: 0px solid red;text-align:right;">--}}
                    {{-- <img class="display-profile-img" src="{{session()->get('user')->image_url}}" alt="img" width="120"
                        height="100" --}} {{-- style="border-radius: 5%;border:0px solid red;">--}}
                    {{-- </div>--}}
                        ...
                        {{-- <form class="profile-form" style="margin-left: 20px;">--}}
                                ...
                                {{-- <div class="row">--}}
                                    {{-- <div class="col-xs-12">--}}
                                        ...
                                        {{-- <input type="file" name="profile_image" id="profile_image"
                                            class="form-control-file" style="border:1px solid #999;">--}}
                                        {{-- <input type="hidden" name="image" class="base64-Image-name">--}}
                                        {{-- </div>--}}
                                    {{-- </div>--}}
                                {{-- </div>--}}
                            {{-- <div class="col-xs-12" style="margin-top: 10px;">--}}
                                {{-- <div class="row">--}}
                                    ...
                                    {{-- <div class="col-sm-12">--}}
                                        {{-- <input name="weekly_newsletter" id="weekly_newsletter" type="checkbox">--}}
                                        {{-- <span> The weekly businesshub newsletter of the most <br />popular steals
                                            across the businesshub site.</span>--}}
                                        {{-- </div>--}}
                                    {{-- <div class="col-sm-12">--}}
                                        {{-- <input name="offers_and_bargains" id="offers_and_bargains" type="checkbox">--}}
                                        {{-- <span> &nbsp; Amazing offers and bargains from our advertising
                                            partners.</span>--}}
                                        {{-- </div>--}}
                                    {{-- </div>--}}
                                {{-- </div>--}}
                            {{-- <div class="col-xs-12" style="margin-top: 10px;">--}}
                                {{-- <div class="row">--}}
                                    {{-- <div class="col-xs-12 text-center">--}}
                                        {{-- <a class="btn add-list-button update-profile-btn update-profile-submit-btn"
                                            --}} {{-- style="padding: 8px;font-size:15px;border-radius:38px;">Update
                                            Profile--}}
                                            {{-- </a>--}}
                                        {{-- </div>--}}
                                    {{-- </div>--}}
